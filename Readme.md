...
Flowmotion is a fork of Simulacrum, packaged for building code-driven animated system flow diagrams.
...
With `flowmotion`, you design using code. And you write code only to solve the design problem and nothing else.
...
You should be writing code **_FOR_** a poller.
...
```html
<iframe width="1200" height="1200" src="https://app.metz.sh/play/0286b754d9e4408ba172e344eeac47b9">
</iframe>
```
